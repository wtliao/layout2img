...
from data.vg import *
from model.resnet_generator_graph import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_eopch', type=int, default=165,
                        help='which checkpoint to load')
    parser.add_argument('--model_path', type=str, default='outputs/tmp/graph/coco_no_geo/128/model/G_{}.pth', help='which epoch to load')
    parser.add_argument('--num_img', type=int, default=5, help="number of image to be generated for each layout")
    parser.add_argument('--sample_path', type=str, default='samples/tmp/graph/coco_no_geo/G{}/128',
